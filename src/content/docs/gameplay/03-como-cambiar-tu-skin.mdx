...
sidebar:
  ...
  order: 4
banner:
  content: '🚫 <strong>Soporte descontinuado:</strong> Los jugadores pueden cambiar de skin desde la misma página web en que fue creado su cuenta o launcher sin necesidad de comandos.'
---
