...
Puedes importar el modpack oficial desde Modrinth. Consulta la guía de [Instalación y configuración segura](/soporte/instalacion-segura).
...
Usa una instancia limpia para Builtechraft. No mezcles mods de otros servidores. Revisa los [mods permitidos](/soporte/mods-permitidos) antes de añadir archivos.
