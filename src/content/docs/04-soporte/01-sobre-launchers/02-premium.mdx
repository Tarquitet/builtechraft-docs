---
title: 1.2. Launcher para Premium
...
Puedes importar el modpack oficial desde Modrinth. Consulta la guía de [Instalación y configuración segura](/04-soporte/02-paquete-de-mods/03-instalacion).
...
Usa una instancia limpia para Builtechraft. No mezcles mods de otros servidores. Revisa los [mods permitidos](/04-soporte/02-paquete-de-mods/01-permitidos) antes de añadir archivos.
