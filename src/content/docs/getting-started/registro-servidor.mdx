...
Una vez que un administrador te haya confirmado que estás en la Whitelist, tu única responsabilidad técnica es iniciar sesión correctamente en tu Launcher (te recomendamos repasar nuestra [Guía de Launchers](/getting-started/sobre-launchers/01-sobre-launchers)):
