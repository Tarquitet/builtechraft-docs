...
sidebar:
  ...
  order: 6
banner:
  content: '🚫 <strong>Soporte descontinuado:</strong> Builtechraft ya no admite conexiones desde Minecraft Bedrock. Esta página se mantiene solo con fines informativos. <a href="/getting-started/como-unirse/02-java">Consulta la guía para Java Edition</a>.'
---
...
<Aside type="caution" title="Importante">
  ...
  <a href="/getting-started/nuestro-discord" class="text-blue-600 dark:text-blue-400 hover:underline">
    {' '}
    Servidor de Discord{' '}
  </a>
</Aside>
